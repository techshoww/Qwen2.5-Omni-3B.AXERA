...
class Qwen2_5OmniSdpaAttention(Qwen2_5OmniAttention):
    ...
    def forward(
        ...
        if output_attentions:
            ...
            logger.warning_once(
                "Qwen2_5OmniForConditionalGeneration is using Qwen2_5OmniSdpaAttention, but `torch.nn.functional.scaled_dot_product_attention` does not support `output_attentions=True`. Falling back to the manual attention implementation, "
